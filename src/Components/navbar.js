...
export default function Navbar() {
    ...
    const dynamicText = textArray[dynamicTextIndex];

    useEffect(() => {
        const textLoad = () => {
            setDynamicTextIndex((prevIndex) => (prevIndex + 1) % textArray.length);
        };
    ...
    <div className="navbar">
        <div className="navbar-main">
            ...
            <div class="container">
                ...
                <span className="second-text">{dynamicText}</span>
            </div>
            <div className="social-media">
                ...
                <a href="https://www.facebook.com" target="_blank" rel="noopener noreferrer">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill=" #962fbf" class="bi bi-instagram" viewBox="0 0 16 16">
                ...
                <a href="https://www.facebook.com" target="_blank" rel="noopener noreferrer">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="black" class="bi bi-twitter-x" viewBox="0 0 16 16">
                ...
                <a href="https://your-contact-us-url.com" target="_blank" rel="noopener noreferrer">
                    <button class="outline-primary-button">CONTACT US</button>
                </a>
            </div>
        </div>
